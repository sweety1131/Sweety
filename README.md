...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="sweety.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>sweety</h1>
            <p>student</p>
        </div>
    </header>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>I'm a <b>software development</b> expert who is passionate about creating dynamic and user-friendly websites. 
    ...
    <section id="education">
        <div class="section-content">
            <h2>Education</h2>
            <p>St Thomas girls higher secondary school
              adithya college arts and science</p>
